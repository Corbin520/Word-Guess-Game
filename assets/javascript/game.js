...
var riderChoices = ["roczen", "anderson", "wilson", "webb", "tomac"];
// Creating a list of letters the user can click on
var alphabet = ["a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m",
    "n", "o", "p", "q", "r", "s", "t", "u", "v", "w", "x", "y", "z"];
// look into using regex instead
...
document.onkeyup = function (event) {
    ...
    // every time user presses a key, it will set letterFound to false
    ...
    if (alphabet.includes(userGuess)) {
        ...
        if (lettersGuessed.includes(userGuess) === false) {
            ...
            // if user enters a letter that is not already in lettersGuessed array then run this code
            for (var i = 0; i < riderChoice.length; i++) {
